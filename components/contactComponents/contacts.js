...
function Contacts() {
    ...
    useEffect(() => {
        ...
        setTab1Content(document.querySelector('#tab1Content'));
        setTab2Content(document.querySelector('#tab2Content'));
    }, [setTab1])
                ...
                <div className="md:pb-350">
                    {active ? 
                        <iframe 
                            ...
                            className='w-full h-400 md:h-500 lg:h-600' loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                        </iframe>
                        :
                        <iframe 
                ...
                <div className="inline-flex flex-col gap-80 p-20 md:p-30 lg:p-40 bg-bgblack md:absolute md:bottom-120">
                    <div className={styles.tab}>
                        <div className="inline-flex gap-40 border-b-2 border-bggray">
                            <button id="tab1" onClick={() => OpenCity('tab1Content')} className="border-b-2 border-blue">United States of America</button>
                            <button id="tab2" onClick={() => OpenCity('tab2Content')} className="border-b-2 border-transparent">O‘zbekiston</button>
                        </div>
                    </div>
